...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6285608625102@s.whatsapp.net`]
...
zeroyt7.sendMessage(`6285608625102@s.whatsapp.net`, options, text, { quoted: ftrol })
...
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/leonganz.kry`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
...
reply(mess.wait)
tahta = args.join(" ")
tahta = await getBuffer(`https://api.zeks.me/api/hartatahta?apikey=apivinz&text=${tahta}`)
...
reply(mess.wait)
thunder = args.join(" ")
thunder = await getBuffer(`https://api.zeks.me/api/thundertext?apikey=apivinz&text=${thunder}`)
...
reply(mess.wait)
bp = args.join(" ")
bp = await getBuffer(`https://api.zeks.me/api/logobp?apikey=apivinz&text=${bp}`)
...
g2 = q.split('|')[1]
reply(mess.wait)
glitch = await getBuffer(`https://api.zeks.me/api/gtext?apikey=${zeks}&text1=${g1}&text2=${g2}`)
...
m2 = q.split('|')[1]
reply(mess.wait)
marvel = await getBuffer(`https://api.zeks.me/api/marvellogo?apikey=${zeks}&text1=${m1}&text2=${m2}`)
